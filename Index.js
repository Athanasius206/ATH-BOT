...
<html lang="en">
	 <head>
			<title>ATHANASIUS AUTOMATED BOT</title>
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				 ...
				 <div class="collapse navbar-collapse justify-content-end" id="navbarNav" style="margin-right: 70px;">
						<ul class="navbar-nav">
							 ...
							 <li class="nav-item">
									<a class="nav-link" href="online_user">Active✔️</a>
							 </li>
              <a class="nav-link" href="https://www.facebook.com/profile.php?id=100090780957801">ALL IN ONE MUSIC</a>
						</ul>
				 </div>
			</nav>
			<div class="container">
